...
const actionMenu = [
  {
    label: "Passport Return Request",
    // route: "/employees/passport-return/passport-return-request",
  },
  { label: "View Details" },
];
...
const SpecialAllowanceModalTable = () => {
...
export default SpecialAllowanceModalTable;
